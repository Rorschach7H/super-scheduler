...
import net.roxia.scheduler.task.runner.InitContextRunner;
import net.roxia.scheduler.task.runner.NettyServerRunner;
import net.roxia.scheduler.task.runner.ScanQueueTaskRunner;
import net.roxia.scheduler.task.runner.TaskRunner;
...
public class SchedulerTaskStartup {
    ...
    private static void start(String cfgPath, String log4jPath) {
        ...
        TaskAppContext context = TaskAppContext.init(TaskCfgLoader.load(cfgPath, log4jPath));
        //初始化系统上下文生成器
